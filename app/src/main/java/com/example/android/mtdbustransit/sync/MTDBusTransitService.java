...
*/
public class MTDBusTransitService extends IntentService {

    private ArrayAdapter<String> mStopsListAdapter;
    private final String LOG_TAG = MTDBusTransitService.class.getSimpleName();

    public MTDBusTransitService() {
        super("MTDBusTransit");
    }
